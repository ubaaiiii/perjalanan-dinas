    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary white">
                <h4 class="modal-title" id="label-modal">Jenis Kegiatan Baru</h4>
            ...
            <form id="form-submit">
                <div class="modal-body"><br>
                  ...
                  <fieldset class="form-label-group">
                      <input type="text" required class="form-control text-uppercase" name="kode-jenis-kegiatan" id="kode-jenis-kegiatan" maxlength="10" placeholder="Kode Jenis Kegiatan">
                      <label for="kode-kegiatan">Kode Jenis Kegiatan :</label>
                  </fieldset>
                  <fieldset class="form-label-group">
...
<script src="<?= base_url(); ?>/app-assets/js/process/jenis_kegiatan.js"></script>
