        ...
        <div class="card-header">
            ...
            <div class="heading-elements">
                <ul class="list-inline mb-0">
                    ...
                    <li><a data-action="reload"><i class="feather icon-rotate-cw users-data-filter"></i></a></li>
                    ...
                    <form>
                        <div class="row">
                            <div class="col-12 col-sm-6 col-lg-3">
                                <label for="users-list-role">Jenis Laporan</label>
                                <fieldset class="form-group">
                                    <select class="form-control" id="jenis-laporan" name="jenis_laporan">
